...
#
#  $ bin/test -s learn.plone -t test_product.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src learn.plone.testing.LEARN_PLONE_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot /src/learn/plone/tests/robot/test_product.robot
#
